...
class Vector3 {
    ...
    getX(v) { return this.elements[0]; }
    getY(v) { return this.elements[1]; }
    getZ(v) { return this.elements[2]; }
    ...
    /**
      * Calculate the dop product between this vector and other.
      * @return scalar
      */
    static dot(other1, other2) {
        // Insert your code here.
        let d = other1.getX()*other2.getX() + other1.getY()*other2.getY() + other1.getZ()*other2.getZ(); // Modify this line to calculate this vector's magnitude.
	...
	let x1 = other1.getX(), y1 = other1.getY(), z1 = other1.getZ();
    	let x2 = other2.getX(), y2 = other2.getY(), z2 = other2.getZ();
    
   	let v3x = (y1 * z2 - z1 * y2);
    	let v3y = (z1 * x2 - x1 * z2);
    	let v3z = (x1 * y2 - y1 * x2);
    	let v3 = new Vector3([v3x, v3y, v3z]);
